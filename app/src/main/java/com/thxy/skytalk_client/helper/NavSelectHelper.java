 ...
 * 达到最优的Fragment切换
 */
public class NavSelectHelper<T> {
    // 所有的Tab集合
    ...
    public NavSelectHelper(Context context, int containerId,
     ...
     * @param tab    Tab
     */
    public NavSelectHelper<T> add(int menuId, Tab<T> tab) {
        tabs.put(menuId, tab);
        return this;
    }
    ...
    public boolean performClickTab(Tab<T> tab) {
        if (tab != null) {
            doSelect(tab);
            return true;
        }
