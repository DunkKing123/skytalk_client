 ...
 *  动态Fragment
 */
public class ActivesFragment extends BaseMVPFragment<ActivesContract.Presenter> implements ActivesContract.View,IActiveFragment{
    ...
    private String mCurrentType=ActiveHelper.TYPE_ALL;
    ...
    protected void onFirstInitData() {
        ...
        showLoading();
        mPresenter.getActives(ActiveHelper.TYPE_ALL);
    }
    ...
    protected void initWidget(View rootView) {
        ...
        mSmartRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                mPresenter.getActives(mCurrentType);
            }
        });
    ...
    @Override
    public void changeActive(String type) {
        mCurrentType =type;
        mPresenter.getActives(type);
        showLoading();
    }
    ...
    class ActiveViewHolder extends RecyclerAdapter.ViewHolder<ActiveModel> implements ActiveItemContract.View,MVPViewHolder {
        ...
        protected void onBind(ActiveModel activeModel) {
            ...
            mPortrait.setup(Glide.with(ActivesFragment.this), activeModel.getPortrait());
            String picture = activeModel.getPicture();
            if (picture != null) {
                mPic.setVisibility(View.VISIBLE);
                Glide.with(ActivesFragment.this).load(picture).centerCrop().placeholder(R.color.grey_200).into(mPic);
            }else {
